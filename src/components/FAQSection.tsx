...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "現金払い（レッスン当日）、銀行振込（事前振込）、クレジットカード決済（PayPal経由）に対応しております。クレジットカード決済では、VISA、Mastercard、JCB、American Expressをご利用いただけます。月額プランや回数券の場合は、事前のお支払いをお願いしております。お客様のご都合に合わせて柔軟に対応いたしますので、ご相談ください。"
    },
    {
